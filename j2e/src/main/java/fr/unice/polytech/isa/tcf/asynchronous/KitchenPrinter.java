...
public class KitchenPrinter implements MessageListener {
	...
	public void onMessage(Message message) {
		try {
			Advantage data = (Advantage) ((ObjectMessage) message).getObject();
			handle(data);
	 ...
	 */
	private void handle(Advantage data) throws IllegalStateException {
		Advantage d = entityManager.merge(data);
		try {
